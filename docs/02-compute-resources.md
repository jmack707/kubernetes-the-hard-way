...
- Set's IP addresses in the range 10.1.20

    | VM            |  VM Name               | Purpose       | IP           | Forwarded Port   |
    | ------------  | ---------------------- |:-------------:| ------------:| ----------------:|
    | master-1      | kubernetes-ha-master-1 | Master        | 10.1.20.11 |     2711         |
    | master-2      | kubernetes-ha-master-2 | Master        | 10.1.20.12 |     2712         |
    | worker-1      | kubernetes-ha-worker-1 | Worker        | 10.1.20.21 |     2721         |
    | worker-2      | kubernetes-ha-worker-2 | Worker        | 10.1.20.22 |     2722         |
    | loadbalancer  | kubernetes-ha-lb       | LoadBalancer  | 10.1.20.30 |     2730         |
