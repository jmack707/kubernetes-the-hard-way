...
```
worker-2$ sudo kubectl config --kubeconfig=/var/lib/kubelet/bootstrap-kubeconfig set-cluster bootstrap --server='https://10.1.20.30:6443' --certificate-authority=/var/lib/kubernetes/ca.crt
